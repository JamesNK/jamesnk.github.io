...
description: "Good (Date)Times with Json.NET"
pubDate: "Feb 21 2009"
source: "https://james.newtonking.com/archive/2009/02/20/good-date-times-with-json-net"
---
Latest version of this guide: [**Serializing Dates in JSON**](http://james.newtonking.com/projects/json/help/?topic=html/DatesInJSON.htm)
...
The default format used by [Json.NET](http://james.newtonking.com/projects/json-net.aspx) for dates is the same one used by Microsoft: "\/Date(1198908717056)\/". You can read more about it [here](http://weblogs.asp.net/bleroy/archive/2008/01/18/dates-and-json.aspx).
