...
description: "Query JSON with full JSONPath support using SelectToken and SelectTokens, and serialize F# discriminated unions automatically with Json.NET 6.0."
pubDate: "Feb 01 2014"
source: "https://james.newtonking.com/archive/2014/02/01/json-net-6-0-release-1-–-jsonpath-and-f-support"
---
## JSONPath

Json.NET has supported basic path queries with SelectToken [since forever](/archive/2009/12/26/json-net-3-5-release-6-binary-json-bson-support). Json.NET 6.0 supes up SelectToken with full support for [JSONPath](http://goessner.net/articles/JsonPath/), an XPath like querying language for JSON.
