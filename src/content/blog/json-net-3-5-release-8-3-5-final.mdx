...
description: "Use TypeNameHandling.Auto in Json.NET 3.5 Final to automatically include type information only when necessary for preserving derived type information."
pubDate: "Aug 14 2010"
source: "https://james.newtonking.com/archive/2010/08/13/json-net-3-5-release-8-3-5-final"
---
Baring any [terrible, terrible damage](http://starcraft.wikia.com/wiki/Terrible_terrible_damage) bugs, Release 8 will be the final 3.5 version of [Json.NET](http://www.newtonsoft.com/json).
