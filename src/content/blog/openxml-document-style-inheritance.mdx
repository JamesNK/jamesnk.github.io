...
description: "Implement an elegant inheritance solution for OpenXML document styles using property elements and delegates to traverse the WordprocessingML style hierarchy."
pubDate: "Jan 08 2008"
...
![Nelson: Make sure your affairs are in order. Bart: I've set up a trust. It bypasses the inheritance tax. Nelson: Only until 2008. Look into it!](../../assets/blog/openxml-document-style-inheritance/styleOrder.png "Nelson: Make sure your affairs are in order. Bart: I've set up a trust. It bypasses the inheritance tax. Nelson: Only until 2008. Look into it!")  
