...
description: "Perform arithmetic and comparison operations on dynamic JSON values and install Json.NET across 7 different frameworks via NuGet 1.2 in Release 2."
pubDate: "Apr 22 2011"
...
![I understand. Let us celebrate our agreement with the adding of chocolate to milk. ](../../assets/blog/json-net-4-0-release-2-nuget-1-2-and-dynamic/contribGraphic_thumb.png "I understand. Let us celebrate our agreement with the adding of chocolate to milk. ")

[NuGet](http://www.nuget.org/) is fast becoming the preferred way to install libraries in .NET. NuGet 1.2 was recently released and among other improvements it adds support for the Windows Phone.
