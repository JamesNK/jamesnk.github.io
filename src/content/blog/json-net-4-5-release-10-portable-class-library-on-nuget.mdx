...
description: "Json.NET 4.5 Release 10 – Portable Class Library on NuGet"
pubDate: "Oct 08 2012"
source: "https://james.newtonking.com/archive/2012/10/07/json-net-4-5-release-10-portable-class-library-on-nuget"
---
[Json.NET's](http://james.newtonking.com/projects/json-net.aspx) major new feature this release is the portable class library assembly is available over NuGet. This is made possible by NuGet 2.1 supporting portable class libraries. Read more about NuGet 2.1 [here](http://docs.nuget.org/docs/release-notes/nuget-2.1).
