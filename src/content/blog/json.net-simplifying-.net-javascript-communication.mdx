...
description: "Get started with Json.NET's core API including JsonReader for parsing, JsonWriter for generating, and JsonSerializer for automatically converting between .NET objects and JSON."
pubDate: "Jun 26 2006"
...
**[Json.NET](http://www.newtonsoft.com/json)** - Json.NET Homepage