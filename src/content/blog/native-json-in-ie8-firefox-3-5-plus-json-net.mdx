...
description: "Learn how to use native JSON parsing in IE8 and Firefox 3.5 together with Json.NET's IsoDateTimeConverter to properly handle date serialization between server and browser."
pubDate: "Apr 12 2009"
source: "https://james.newtonking.com/archive/2009/04/12/native-json-in-ie8-firefox-3-5-plus-json-net"
---
![Kent Brockman: &quot;Here's a float saluting the Native Americans, who taught us how to celebrate Thanksgiving.&quot; Leeza Gibbons: &quot;Interesting side note on this float, the papier-mache is composed entirely out of broken treaties.&quot; Kent: &quot;Ha ha ha ha, they're good sports!&quot;](../../assets/blog/native-json-in-ie8-firefox-3-5-plus-json-net/ie8logo.png "Kent Brockman: &quot;Here's a float saluting the Native Americans, who taught us how to celebrate Thanksgiving.&quot; Leeza Gibbons: &quot;Interesting side note on this float, the papier-mache is composed entirely out of broken treaties.&quot; Kent: &quot;Ha ha ha ha, they're good sports!&quot;")
...
This post looks at how to use native JSON and how it can complement [Json.NET's](http://www.newtonsoft.com/json) server side JSON support by parsing and generating JSON on the browser.
...
The first thing we want to do is make Json.NET write dates in the ISO format. [IsoDateTimeConverter](/archive/2009/02/20/good-date-times-with-json-net) to the rescue.
