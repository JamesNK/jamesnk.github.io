...
description: "Explore the beta release of LINQ to JSON, a new Json.NET API that enables declarative creation and powerful querying of JSON objects using LINQ-style syntax."
pubDate: "Feb 10 2008"
source: "https://james.newtonking.com/archive/2008/02/11/linq-to-json-beta"
---
![Oh no, Beta!](../../assets/blog/linq-to-json-beta/json160.gif "Oh no, Beta!")

I like LINQ. A lot. For the past few months I have been fortunate to work on a .NET 3.5 project and I have been making heavily use of [LINQ](/archive/2007/12/21/linq-over-ooxml-loving-it) [to](/archive/2007/12/11/linq-to-xml-over-large-documents) [XML](/archive/2007/12/03/getting-started-with-ooxml). While using XLINQ it occurred to me that a similar API for working with JSON objects, which share a lot of similarities with XML, would be useful in many situations.
...
LINQ to JSON is an addition to [Json.NET](http://www.newtonsoft.com/json). It sits under the Newtonsoft.Json.Linq namespace.
