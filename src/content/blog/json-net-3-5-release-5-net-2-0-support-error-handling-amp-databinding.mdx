...
description: "Json.NET 3.5 Release 5 – .NET 2.0 Support, Error Handling & Databinding"
pubDate: "Oct 11 2009"
...
If you’re interested in the details I have previously blogged about adding .NET 2.0 support to Json.NET [here](http://james.newtonking.com/archive/2009/08/02/net-2-0-support-added-to-json-net.aspx).
...
Find more documentation about error handling [here](http://james.newtonking.com/projects/json/help/SerializationErrorHandling.html).
