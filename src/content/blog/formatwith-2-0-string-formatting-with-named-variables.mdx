...
description: "FormatWith 2.0 - String formatting with named variables"
pubDate: "Mar 28 2008"
...
I have updated the original [FormatWith](http://james.newtonking.com/archive/2008/03/27/formatwith-string-format-extension-method.aspx) with an overload that takes a single argument and allows the use of property names in the format string.
