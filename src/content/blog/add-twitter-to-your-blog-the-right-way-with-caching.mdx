...
description: "Add Twitter to your blog the right way with caching"
pubDate: "Feb 22 2009"
source: "https://james.newtonking.com/archive/2009/02/21/add-twitter-to-your-blog-the-right-way-with-caching"
---
![Trying is the first step toward failure.](http://james.newtonking.com/images/AddTwittertoyourblogTherightway_9350/failwhale.png "Trying is the first step toward failure.")

Twitter (read more about Twitter [here](http://james.newtonking.com/archive/2008/04/28/thoughts-on-twitter.aspx)) offers a [simple JavaScript API](http://twitter.com/widgets/html_widget) to add your status updates to your blog or other website.
...
I use this technique on my blog (look to the sidebar on the right). You can also see an example webpage I threw together [**here**](http://james.newtonking.com/blogfiles/twittercaching/twittercaching.html).