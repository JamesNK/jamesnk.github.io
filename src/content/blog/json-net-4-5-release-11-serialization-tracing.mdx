...
description: "Learn how to debug and log Json.NET serialization using the new ITraceWriter interface, escape HTML and non-ASCII characters, and benefit from 400% faster JToken.ToObject performance."
pubDate: "Nov 20 2012"
...
Read more about trace writing here: [**Debugging with Serialization Tracing**](http://www.newtonsoft.com/json/help/html/SerializationTracing.htm)
