...
description: "Reduce memory allocations and garbage collection overhead using the new IArrayPool interface for buffer reuse, and benefit from improved comment handling in JArrays."
pubDate: "Dec 29 2015"
