...
description: "Use JsonIgnoreAttribute to exclude properties from serialization and AspNetAjaxDateTimeConverter for compatibility with Microsoft's ASP.NET AJAX date format."
pubDate: "Jan 20 2007"
...
This long overdue release of [Json.NET](http://www.newtonsoft.com/json) is mostly the result of feedback from users. Thanks for all the suggestions. 
...
[**Download Json.NET**](http://www.newtonsoft.com/json) - Json.NET dll and C# source code.