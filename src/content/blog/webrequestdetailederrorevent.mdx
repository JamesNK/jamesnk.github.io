...
description: "Implement a custom ASP.NET 2.0 health monitoring event that captures comprehensive request details including headers, form values, cookies, and server variables when unhandled exceptions occur."
pubDate: "Aug 10 2006"
source: "https://james.newtonking.com/archive/2006/08/10/WebRequestDetailedErrorEvent"
---
**[Download DetailedErrorEvent](/downloads/detailederrorevent/detailederrorevent.zip)** - DetailedErrorEvent dll and C# source code
