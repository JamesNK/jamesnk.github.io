...
description: "ASP.NET MVC and Json.NET"
pubDate: "Oct 16 2008"
source: "https://james.newtonking.com/archive/2008/10/16/asp-net-mvc-and-json-net"
---
This is an ActionResult I wrote to return JSON from [ASP.NET MVC](http://www.asp.net/mvc/) to the browser using [Json.NET](http://james.newtonking.com/projects/json-net.aspx).
