...
The Wellington .NET usergroup had a [special event](http://pageofwords.com/blog/2008/10/27/PDCFireworksInWellington.aspx) last week covering what was announced at PDC. I gave a brief 15 minute introduction to using the Silverlight chart control. You can get the slides from my talk (all 6 of them!) [here](http://james.newtonking.com/downloads/pdcfireworks/silverlightcharting.pptx).
  
[![Duffman thrusting in the direction of the problem!](http://james.newtonking.com/images/PDC2008CreatingSharePointApplicationswit_10BFB/contosomainpage_thumb.png "Duffman thrusting in the direction of the problem!")](http://james.newtonking.com/images/PDC2008CreatingSharePointApplicationswit_10BFB/contosomainpage.png)