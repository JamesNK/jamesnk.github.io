...
description: "Learn about Json.NET 4.5's major features including ISO 8601 date formatting as the new default, async serialization methods, and Windows 8 Metro application support."
pubDate: "Mar 20 2012"
...
Hopefully this should reduce the amount of assembly binding redirecting [going on](/archive/2012/02/11/json-net-4-0-release-8-bug-fixes) for everyone.
