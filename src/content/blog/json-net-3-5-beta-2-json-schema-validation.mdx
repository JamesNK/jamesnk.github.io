...
description: "Json.NET 3.5 Beta 2 – JSON schema validation"
pubDate: "Jan 04 2009"
...
I’ve been hard at work on [Json.NET](http://james.newtonking.com/projects/json-net.aspx) over the holidays. I spent most of December setting up environments, writing PowerShell scripts and deploying applications so it was nice to do a little .NET development for a change.
...
I have put together a demo page of the new JSON Schema features: [**JSON Schema Validation Demo**](http://james.newtonking.com/projects/json/schema.aspx)
