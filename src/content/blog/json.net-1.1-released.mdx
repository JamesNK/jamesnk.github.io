...
description: "Convert between XML and JSON effortlessly using the new XmlNodeConverter class and helper methods introduced in Json.NET 1.1."
pubDate: "Jul 11 2006"
source: "https://james.newtonking.com/archive/2006/07/10/Json.NET-1.1-released"
---
Thanks again to the people that have tried out [Json.NET](http://www.newtonsoft.com/json) and have reported bugs or offered suggestions. This release addresses all the issues that you've reported and that I'm aware of. 1.1 also adds a few new features.
...
Json.NET 1.1 can be downloaded [here](http://www.newtonsoft.com/json).