...
description: "Json.NET 3.5 Release 6 – Binary JSON (BSON) support"
pubDate: "Dec 27 2009"
...
[SelectToken](http://james.newtonking.com/projects/json/help/html/M_Newtonsoft_Json_Linq_JToken_SelectToken.htm) provides a method to query LINQ to JSON using a single string path to a desired JToken. SelectToken is handy for dynamic queries easy because the entire query is defined in a string.
